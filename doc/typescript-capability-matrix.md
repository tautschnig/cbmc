...
See [typescript-fixes-changelog.md](typescript-fixes-changelog.md) for the
full historical record of 45+ bugs found and fixed during spec cross-
referencing, soundness reviews, and property-based fuzzing (2026-05-07
through 2026-05-14). Each entry cites the CORE regression test that guards
against regression and the commit that fixed it.
