...
echo "=== unit: integer_overflow_in_alloc_size ==="
run_gotocc integer_overflow_in_alloc_size.c test_unit.c -o "$tmp/unit.gb"
...
if [[ $fail -eq 0 ]]; then
  echo
  echo "integer_overflow_in_alloc_size tests behaved as expected."
  exit 0
fi
