...
echo "=== unit: tocttou_inode_check ghost + helpers ==="
run_gotocc tocttou_inode_check.c test_unit.c -o "$tmp/unit.gb"
...
if [[ $fail -eq 0 ]]; then
  echo
  echo "tocttou_inode_check tests behaved as expected."
  exit 0
fi
