...
/* FUNCTION: __atexit_handler */

extern __CPROVER_thread_local void (*__CPROVER_atexit_table[32])(void);
extern __CPROVER_thread_local int __CPROVER_atexit_table_use;
