...
Function: memory_model_rmot::~memory_model_rmot
...
memory_model_rmot::~memory_model_rmot()
{
}

/*******************************************************************\

Function: memory_model_rmot::po_is_relaxed
...
bool memory_model_rmot::po_is_relaxed(
...
Function: memory_model_rmot::add_program_order
...
void memory_model_rmot::add_program_order(
    partial_order_concurrencyt &poc,
