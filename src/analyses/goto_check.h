...
#define HELP_GOTO_CHECK \
  ...
  " --cache-information-leak-check\n" \
  "                              check for information side channels via CPU caches\n" /* NOLINT(whitespace/line_length) */ \
...
#define PARSE_OPTIONS_GOTO_CHECK(cmdline, options) \
  ...
  options.set_option("cache-information-leak-check", cmdline.isset("cache-information-leak-check")); /* NOLINT(whitespace/line_length) */ \
