...
{
public:
  explicit rust_builtin_code_typet(code_typet &code):
    code_typet(code)
  {
...
inline rust_builtin_code_typet &to_rust_builtin_code_type(
  code_typet &code)
{
...
inline bool is_rust_builtin_code_type(const typet &type)
{
  return type.id()==ID_code &&
         type.get_bool("rust_builtin_proceduret");
}

class rust_spec_code_typet:public code_typet
{
public:
  explicit rust_spec_code_typet(code_typet &code):
    code_typet(code)
  {
...
inline rust_spec_code_typet &to_rust_spec_code_type(
  code_typet &code)
{
...
{
  return type.id()==ID_code &&
         type.get_bool("rust_spec_proceduret");
}
