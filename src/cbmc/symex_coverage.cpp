  ...
  coverage_recordt("method")
{
      ...
      ++it)
  {
    ...
    line.set_attribute("number", i2string(it->first));
    line.set_attribute("hits", i2string(it->second.hits));
