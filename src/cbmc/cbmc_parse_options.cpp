...
void cbmc_parse_optionst::help()
{
  ...
  std::cout <<
    ...
    " --debug-level level          UNDOCUMENTED\n"
    " --fixedbv                    UNDOCUMENTED\n"
    " --floatbv                    UNDOCUMENTED\n"
    " --no-simplify                UNDOCUMENTED\n"
    " --no-simplify-if             UNDOCUMENTED\n"
    " --show-value-sets            UNDOCUMENTED\n"
    " --slice-by-trace             UNDOCUMENTED\n"
    " --string-abstraction         enable additional char* property tracking\n"
    " --verbosity level            UNDOCUMENTED\n"
    " --no-propagation             disable constant propagation\n"
    " --document-subgoals          UNDOCUMENTED\n"
    " --vcd                        UNDOCUMENTED\n"
    " --opensmt                    UNDOCUMENTED\n"
    " --fpa                        UNDOCUMENTED\n"
    " --win32                      UNDOCUMENTED\n"
    " --decide                     UNDOCUMENTED\n"
    "\n";
